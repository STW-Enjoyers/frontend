...
export const OPTION_RELEVANCE:string = "comentarios destacados";
export const OPTION_DATE:string = "comentarios más recientes";
export const MAX_COMMENTS_PER_PAGE:number = 10;
